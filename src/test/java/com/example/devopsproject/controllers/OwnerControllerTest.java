...
public class OwnerControllerTest {
    ...
    void testGetOwnersSuccess() throws Exception {
        ...
        Owner owner1 = new Owner("ayadinou", 26);
        Owner owner2 = new Owner("mehdi", 25);
        ...
        mockMvc.perform(get("/owner/all"))
                ...
                .andExpect(jsonPath("$[0].name", is("ayadinou")))
                .andExpect(jsonPath("$[0].age", is(26)))
                .andExpect(jsonPath("$[1].name", is("mehdi")))
    ...
    void testGetOwnerById() throws Exception {
        ...
        Owner owner = new Owner(1l,"ayadinou", 26);
        ...
        mockMvc.perform(get("/owner/{id}", 1L))
                ...
                .andExpect(jsonPath("$.name", is("ayadinou")))
    ...
    void testCreateWidget() throws Exception {
        // Set up our mocked service
        Owner ownerToCreate = new Owner("ayadinou",12 );
        Owner ownerToReturn = new Owner(1L, "ayadinou",12);
